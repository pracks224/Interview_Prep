...
<details>
  ...
  -  ${\color{red} AWS}$
      ...
      - [EC2](./INTERVIEW_CLOUD_AWS_AZURE_GCP/AWS_EC2.md)
      - [ELB](./INTERVIEW_CLOUD_AWS_AZURE_GCP/AWS_ELB.md)
      - [EBS](./INTERVIEW_CLOUD_AWS_AZURE_GCP/AWS_EBS.md)
      - [VPC](./INTERVIEW_CLOUD_AWS_AZURE_GCP/AWS_VPC.md)
      - [SNS](./INTERVIEW_CLOUD_AWS_AZURE_GCP/AWS_SNS.md)
      - [SQS](./INTERVIEW_CLOUD_AWS_AZURE_GCP/AWS_SQS.md)
      - [RDS](./INTERVIEW_CLOUD_AWS_AZURE_GCP/AWS_RDS.md)
      - [Dynamo DB](./INTERVIEW_CLOUD_AWS_AZURE_GCP/AWS_DynamoDB.md)
      - [CloudWatch](./INTERVIEW_CLOUD_AWS_AZURE_GCP/AWS_Cloud_Watch.md)
      - [CloudFormation](./INTERVIEW_CLOUD_AWS_AZURE_GCP/AWS_CloudFormation.md)
      - [Cognito](./INTERVIEW_CLOUD_AWS_AZURE_GCP/AWS_Cognito.md)
      - [IAM](./INTERVIEW_CLOUD_AWS_AZURE_GCP/AWS_IAM.md)
      - [KINESIS](./INTERVIEW_CLOUD_AWS_AZURE_GCP/AWS_KINESIS.md)
      - [REDSHIFT](./INTERVIEW_CLOUD_AWS_AZURE_GCP/AWS_REDSHIFT.md)
  - #### GPC
      - [APIGEE]()
  - #### AZURE
</details>
