...
**VPC CIDR Block:** CIDR (Classless Inter Domain Routing) IP address range defines a range of IP addresses which AWS will use to assign _**private**_ IP address to EC2 instances.
